...
<head>
<meta charset="UTF-8">
<title>My Daily Diary; write</title>
...
<h1><%=session.getAttribute("id")%>'s Daily Diary
	...
	<div class="calendar-wrapper" id="calendar-wrapper">
		<form action="../controller/write.jsp?date=${date }" method="post" id="writeForm">
	...
	<div class="row d-flex justify-content-center align-items-center h-100">
		<div id="content" class="mb-md-5 mt-md-4 pb-5">
			<button id="insert" name="insert" class="btn btn-primary px-5" type="button">입력</button>
